...
# Product Code (or SKU), Product Name, Description, Category, Selling Price, Discount (If any) Brand, Colour and
...
class Shop(models.Model):
    ...
    image = models.ImageField(upload_to=shop_directory_path, validators=[validate_image], verbose_name='Shop Image',
                              null=True)
...
class Brand(models.Model):
    ...
    image = models.ImageField(upload_to=brand_directory_path, validators=[validate_image], verbose_name='Brand Image',
                              null=True)
...
class Category(models.Model):
    ...
    image = models.ImageField(upload_to=category_directory_path, validators=[validate_image],
                              verbose_name='Category Image', null=True)
...
class Order(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        user = self.user
        print(self.id)
        self.order_no = str(shop.location.city.id) + '/' + str(shop.location.id) + '/' + str(user.id) + '/' + str(
            shop.id) + '/' + str(self.id)
