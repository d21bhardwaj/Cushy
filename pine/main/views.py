    ...
    if request.user.is_authenticated and request.user.id == user.id:
        if request.method == "POST":
            ...
            if form.is_valid() and imageform.is_valid():
                ...
                return render(request, "message.html", {"background": "bg-success", "title": "Successfully Submitted",
                                                        "head": "Successfully Submitted",
                                                        "body": "Your Room Will be Shown after viewing details submitted by you. Please wait till then!"})
            else:
    ...
    if request.user.is_authenticated and request.user.id == user.id:
        ...
        if request.method == "POST":
            ...
            if form.is_valid() and imageform.is_valid():
                ...
                return render(request, "message.html", {"background": "bg-success", "title": "Successfully Submitted",
                                                        "head": "Successfully Submitted",
                                                        "body": "Your PG Will be Shown after viewing details submitted by you. Please wait till then!"})
            else:
                print(form.errors, imageform.errors)
        else:
            form = RentPGForm()
...
def contact(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, "message.html", {"background": "bg-success", "title": "Successfully Submitted",
                                                    "head": "Successfully Submitted",
                                                    "body": "We are grateful you contacted us ,  will revert back to you soon."})
...
def detailroom(request, room_id, image_id):
    ...
    try:
        ...
        return render(request, 'room_detail.html',
                      {'rooms': rooms, 'images': images, 'seller': seller, 'prof': profile})
    except ObjectDoesNotExist:
